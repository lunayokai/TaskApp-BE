...
module.exports = {    
    registerTemplate: (asunto, contenido, link) => `
  ...
  <table align="center" style="text-align: center; vertical-align: top; width: 600px; max-width: 600px; background-color:rgb(250, 187, 92);" width="600">
  <tbody>
    <tr>
      <td style=" width: 596px; vertical-align: top; padding-left: 10px; padding-right: 10px; padding-top: 15px; padding-bottom: 15px;" width="596">
        ...
        <img src="${baseUrl}/images/taskAppLogo.png" alt="Logo" title="Logo" style="display:block; margin:auto; width: 150px; max-width: 150px; height: 45px; max-height: 45px; text-align: center; color: #ffffff;" />
      </td>
      </td>
    </tr>
  </tbody>
      ...
      <tbody>
        <tr>
          <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
            ...
            <p style="margin-top: 50px; font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;">
            
            <a style="padding: 20px; border-radius: 30px; color: #ffffff; background:rgb(35, 35, 35);" href="${link}">Confirme su email</a>
            </p>
        ...
        <tr>
          <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 30px;" width="596">
            ...
            <p style="margin-bottom: 0; font-size: 13px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #1f2831;">
              <a target="_blank" style="text-decoration: underline; color: #ffffff;" href="https://taskapp-be.onrender.com">
